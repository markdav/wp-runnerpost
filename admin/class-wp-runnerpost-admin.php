...
/**
 * @package WP_RunnerLog_Admin
 * @author  Your Name <email@example.com>
 */
class WP_RunnerPost_Admin {
    ...
    private function __construct() {
         ...
         *
         */
        $plugin = WP_RunnerPost::get_instance();
    ...
    public function enqueue_admin_styles() {
        ...
        if ( $this->plugin_screen_hook_suffix == $screen->id ) {
            wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), WP_RunnerPost::VERSION );
        }
    ...
    public function add_plugin_admin_menu() {
        ...
        $this->plugin_screen_hook_suffix = add_options_page(
            ...
            __( 'Manage Run Log', $this->plugin_slug ),
            'manage_options',
            $this->plugin_slug,
    ...
    public function saveRunEntry(){
        ...
        if( wp_verify_nonce( $nonce, 'ajax-save-run-nonce' ) ) {

            $table_name = $wpdb->prefix . "runnerpost_log";

            // Store the distance in km (might as well be metric about it)
            if($run_unit == "miles"){
                $run_distance = round($run_distance*=KILOMETERS_IN_MILE,1);
            }
            ...
            echo "Dredd says: nice try, creep";
        }
        die();
    }
